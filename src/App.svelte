<script>
  ...
  import { openDB, ensureDefaultAccount } from './lib/data/db.js';
  ...
  // Top-level tabs plus the Settings > Accounts > Add Account screens
  // reached from Settings. Child screens keep the Settings tab
  // highlighted; their back button returns straight to Settings
  // (see specs/accounts.md).
  ...
  const TAB_FOR_SCREEN = {
    ...
    Settings: 'Settings', Accounts: 'Settings', AddAccount: 'Settings'
  };
  ...
  {:else}
    <div class="screen-area">
      ...
      {:else if screen === 'Settings'}
        <Settings onOpenAccounts={() => screen = 'Accounts'} />
